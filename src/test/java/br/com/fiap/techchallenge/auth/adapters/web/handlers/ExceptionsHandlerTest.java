...
class ExceptionsHandlerTest {
    ...
    @Test
    void shouldHandleAuthenticationTokenInvalidException() {
        var exception = new AuthenticationTokenInvalidException("message");
        var httpservletRequest = new MockHttpServletRequest();

        var response = exceptionsHandler.handlerAuthenticationTokenInvalidException(exception, httpservletRequest);
